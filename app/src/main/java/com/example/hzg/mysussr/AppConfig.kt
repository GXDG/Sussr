...
object AppConfig {
    ...
    val provider_Path = "com.example.hzg.mysussr.fileprovider"
    ...
    val SUSSR_SRC_PATH_gz = "${FILE_PATH}/sussr${SUSSR_VERSION}.tar.bz2";   //sussr安装文件路径
    val SUSSR_SRC_PATH_tar = "${FILE_PATH}/sussr${SUSSR_VERSION}.tar";   //sussr安装文件路径
    ...
    //  "tar -zxvf xxx.tar.gz -C directoryname"
    val Shell_install_sussr_Tar = "bunzip2 -vkf ${SUSSR_SRC_PATH_gz} "
    val Shell_install_sussr_Tar_1 = "tar -xf ${SUSSR_SRC_PATH_tar} -C ${PATH_SUSSR_DIR} "
    ...
    val ReInstall_Sussr1 = arrayOf(Shell_remove_sussr, Shell_mkdir_sussr, Shell_install_sussr_Tar, Shell_install_sussr_Tar_1, Shell_chmod_sussr)
